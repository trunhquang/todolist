...
class AppColors {
  ...
  static Color primary = const Color(0xFF081F40); // RGB(8, 31, 64)
  static Color onPrimary = const Color(0xFFFFFFFF);
  static Color primaryContainer = const Color(0xFFB3C7E8); // Light blue container
  static Color onPrimaryContainer = const Color(0xFF001A2E); // Dark text on light blue
  ...
  // Task Type Colors
  static Color dailyTask = const Color(0xFF081F40); // tie to primary
  ...
  // Priority Colors
  static Color lowPriority = const Color(0xFF081F40);
  ...
  static Color completedStatus = const Color(0xFF081F40);
  static Color cancelledStatus = const Color(0xFFF44336);

  // Additional Colors
  static Color success = const Color(0xFF081F40);
